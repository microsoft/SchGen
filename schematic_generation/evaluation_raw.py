...
MAX_TOKENS = 13312
model_names = ["gpt-oss-20b-pcb-schematic_raw"]
...
<<<<<<< HEAD
    ...
    if model_name == None:
        ...
        peft_model_id = Path(project_path) / model_name
...
>>>>>>> 8df8b541cd6760342ab5afbd5dedfe0e526a0b47
    ...
    out_jsonl = os.path.join(out_dir, f"eval_results_seed_{model_name}.jsonl")
    out_csv   = os.path.join(out_dir, f"eval_results_seed_{model_name}.csv")
...
<<<<<<< HEAD
                ...
                # Directly extract the final schematic content
                sch = get_final_sch(response)
