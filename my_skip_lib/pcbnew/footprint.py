...
from my_skip_lib.sexp.parser import ParsedValue, ParsedValueWrapper, ArbitraryNamedParsedValueWrapper
from my_skip_lib.pcbnew.layer import LayerPropertyHandler
...
class FootprintCollection(NamedElementCollection):
    ...
    def value_matches(self, regex:str):
        return list(filter(lambda s: re.fullmatch(regex, s.Value.value), self))
