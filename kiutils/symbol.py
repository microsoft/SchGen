...
class Symbol():
    ...
    def from_sexpr(cls, exp: list) -> Symbol:
        ...
        for item in exp[2:]:
            ...
            if item[0] == 'pin_numbers':
                ...
                if len(item[1]) > 1 and item[1][0] == 'hide' and item[1][1] == 'yes':
                    object.hidePinNumbers = True
            if item[0] == 'pin_names':
                ...
                for property in item[1:]:
                    if type(property) == type([]):
                        ...
                        if property[0] == 'hide': object.pinNamesHide = True
    ...
    def to_sexpr(self, indent: int = 2, newline: bool = True) -> str:
        ...
        # pinnumbers = f' (pin_numbers (hide yes))' if self.hidePinNumbers else '' # For kiCAD v9
        pinnumbers = f' (pin_numbers hide)' if self.hidePinNumbers else '' # For kiCAD v9
